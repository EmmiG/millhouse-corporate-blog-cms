        ...
        <div id="blog" class="content_wrap">
            ...
            function postamount() {
						...
						if(isset($_GET['page']) && $_GET['page'] > 1) {
							$page_links .= "<li class='page-item'><a class='page-link' href='index.php?page=".($_GET['page'] - 1)."' aria-label='Previous'><span aria-hidden='true'>&laquo;</span><span class='sr-only'>Previous</span></a></li>";
						}
						if(empty($_GET['page'])) {
